"""
TITLE: Süsse Wurst HR New Employee Onboarding GUI
AUTHOR: N.F. Desmond
DATE: November 2025
DESCRIPTION: This module implements a GUI for onboarding new employees 
into the Süsse Wurst HR database. It features fields for entering 
personal information, contact details, and hiring specifics, along 
with buttons to discover position details and finalize the onboarding 
process. An Employee ID is auto-generated to ensure uniqueness.
"""
...
class OnboardingGui:
  ...
  def __init__(self, root, cxn):
    ...
    self.logo = tk.PhotoImage(file=r'sw_db_application\sw_logos\sw_onboard_logo.png')
    ...
    maintwo_style.configure('MainTwo.TFrame',
                            background='#FBF3DD')
