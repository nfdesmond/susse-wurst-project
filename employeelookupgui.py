...
class EmployeeLookupGUI:
    def __init__(self, root, cxn):
        ...
        emp_id_entry = ttk.Entry(mainframe, width=10, textvariable=self.emp_id_var)
        ...
        emp_name_label = ttk.Label(mainframe, textvariable=self.emp_name_var)
        ...
        job_label = ttk.Label(mainframe, textvariable=self.job_title_var)
        ...
        dept_name_label = ttk.Label(mainframe, textvariable=self.dept_name_var)
        ...
        mgr_name_label = ttk.Label(mainframe, textvariable=self.mgr_name_var)
        ...
        tenure_var_label = ttk.Label(mainframe, textvariable=self.tenure_var)
        tenure_var_label.grid(column=4, row=6, sticky=tk.W)
        
        self.not_found_var = tk.StringVar()
        not_found_msg_label = ttk.Label(mainframe, textvariable=self.not_found_var)
